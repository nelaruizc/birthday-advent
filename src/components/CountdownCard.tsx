...
export const CountdownCard = ({ daysData, openedGifts, isUnlocked, markOpened }: Props) => (
  <section id="adventure" className="rounded-mega bg-[#FFFFFF] px-5 pb-5 pt-6">
    <div className="grid grid-cols-[minmax(0,auto)_auto] items-start justify-start gap-4">
      <div className="w-fit max-w-full">
        <h2 className="inline-block font-serif leading-[1.08] text-[#59607a]">
        ...
        <span className="mt-4 block h-[2px] w-full rounded-full bg-[#8f98b3]/50" aria-hidden="true" />
      </div>
      <div className="mt-1 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#4b73f0] text-[#ffffff]/95">
        <svg
